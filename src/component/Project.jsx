...
import PPDb from "../assets/PPDB.png";
        ...
        <div className="flex w-full justify-center items-center ">
          <div className="justify-center items-center w-full max-w-[360px] p-5 lg:grid lg:grid-cols-3 lg:max-w-[1080px]">
            <CardProject
              ...
              button="Lihat"
              onClick={() =>
                (window.location.href = "https://laznasalirsyad.org/")
              }
            />
            <CardProject
              image={PPDb}
              title="PPDB SMP Muhammadiyah"
              deskripsi=" website ini dibangun untuk membantu PPDB di SMP Muhammadiyah Sumbang dan bisa dijadikan sebagai website profill sekolah"
              button="Lihat"
              onClick={() =>
                (window.location.href =
                  "https://ppdb-smp-muh-sumbang.vercel.app/")
              }
            />
            <CardProject
              image={Admin}
              title="CMS PPDB SMP Muhammadiyah"
              deskripsi=" website CMS ini digunakan sebagain media untuk mengatur informasi yang ada di web user PPDB SMP Muhammadiyah"
              button="Lihat"
              onClick={() =>
                (window.location.href = "https://admin-spemba.vercel.app/")
              }
            />
            <CardProject
              image={kitchenapp}
              ...
              button="Lihat"
              onClick={() =>
                (window.location.href = "https://www.kitchencraft.site/")
              }
            />
            <CardProject
              image={apotik}
              ...
              button="Lihat"
              onClick={() =>
                (window.location.href = "https://apotik-sejahtera.vercel.app/")
              }
            />
            <CardProject
              image={sedekahkurma}
              ...
              button="Lihat"
              onClick={() =>
                (window.location.href = "https://sedekahkurma.com/")
              }
            />
            <CardProject
              image={nyahsiok}
              ...
              button="Lihat"
              onClick={() =>
                (window.location.href = "https://gindadwi.github.io/Umkm/")
              }
            />
            <CardProject
              image={portoSaya}
              title="Portofolio Sederhana"
              deskripsi="website portofolio sederhana ini menggunakan bootstrap dan java script ini merupakan website pertama portofolio saya"
              button="Lihat"
              onClick={() =>
                (window.location.href =
                  "https://gindadwi-github-io.vercel.app/")
              }
            />
          </div>
        </div>
