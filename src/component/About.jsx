...
export default function About() {
    ...
    return (
        <div className='bg-Abu_Abu pt-5 py-14 mx-[-33px] lg:mx-[-70px] lg:py-24 '>
            ...
            {modalContent && (
                <div id="About-modal" data-modal-backdrop="static" tabIndex="-1" aria-hidden="true" className="fixed bg-black bg-opacity-50 items-center justify-center flex top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto h-modal md:h-full">
                    <div className="relative w-full h-screen max-w-2xl md:h-auto bg-slate-400">
