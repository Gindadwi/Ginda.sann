...
export default function About() {
  ...
  return (
    <div
      id="About"
      className="bg-Abu_Abu pt-5 py-14 mx-[-33px] lg:mx-[-70px] lg:py-[-10px] lg:pb-[5px] "
    >
      <div className=" w-full flex justify-center items-center h-[450px] pb-5 pt-5">
        <div className="justify-center items-center w-full max-w-[360px] lg:max-w-[1080px] lg:flex">
          <img
            src={BgFoto}
            className="absolute w-[300px] h-[220px] left-14 
                    rounded-lg z-0 lg:left-52 lg:h-[280px] lg:w-[400px] lg:mt-[-50px] 2xl:left-[500px] shadow"
            alt=""
          />
          <CardProject
      ...
      {modalContent && (
        <div
          ...
          tabIndex="-1"
          aria-hidden="true"
          className="fixed bg-black bg-opacity-50 items-center justify-center flex flex-col top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto h-modal md:h-full"
        >
          <div className="relative w-full h-screen max-w-2xl md:h-auto ">
            <div className="relative bg-white rounded-lg shadow">
              ...
              <div className="p-4 space-y-4">
                <p className="text-[12px] lg:text-[14px] leading-relaxed text-back font-poppins text-left dark:text-gray-400">
                  {modalContent}
                </p>
              </div>
