...
export default function Nav() {
  ...
  return (
    <div className="relative">
      <header className="bg-gradient-to-r from-black via-blue-900 to-blue-600 w-full items-center fixed top-0 left-0 z-20">
        <div className="p-4 flex items-center justify-between mx-auto max-w-[1080px]">
          ...
          <nav className=" gap-10 hidden sm:flex">
            <a
              href="#HeroMenu"
              className="text-white hover:cursor-pointer hover:border-b-2 hover:transition-all hover:duration-300 hover:ease-in-out py-2 pl-2 text-lg cursor-pointer"
            >
              Home
            </a>
            <a
      ...
      <div
        className={`fixed top-0 right-0 h-full w-1/2 bg-white transform ${
      ...
      >
        ...
        <nav className="text-left font-poppins text-base lg:flex lg:gap-7">
          <div className="text-black py-2 pl-2 text-lg cursor-pointer transition duration-300 ease-in-out hover:bg-blue-400 hover:text-white">
            <a className="w-full" href="#HeroMenu">
              Home
            </a>
          </div>

          <div className="text-black py-2 pl-2 text-lg cursor-pointer transition duration-300 ease-in-out hover:bg-blue-400 hover:text-white">
            <a className="w-full" href="#Skill">
              Skill
            </a>
          </div>

          <div className="text-black py-2 pl-2 text-lg cursor-pointer transition duration-300 ease-in-out hover:bg-blue-400 hover:text-white">
            <a className="w-full" href="#Project">
              Project
            </a>
          </div>
