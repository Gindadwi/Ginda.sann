    ...
    return (
        <div className='mx-[-33px] lg:mx-[-70px]'>
            ...
            <div
                ...
                >
                    <div>
                        <h3 className="font-baloo text-white text-3xl ">
                            Hai, I'm
                        </h3>
                        <h1 className="flex pt-2 font-baloo text-white text-4xl ">
                            Gi <Typewriter
                                options={{
                    ...
                    <div className="items-center justify-center w-full flex flex-col lg:mt-[-50px] lg:ml-[50px]">
                        <img src="/src/assets/FotoSaya.png" alt="ginda dwi" className="w-[350px]" />
                        <div className="mt-4">
                            <SocialMediaIcons />
                        </div>
                    </div>
